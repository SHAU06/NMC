      ...
      <?php  include('error.php'); ?>
        ...
        <div class="col-md-4 ml-auto mr-auto">
          ...
          <div class="card card-login card-plain">
            <?= form_open('forgotPassword','class="form" method="POST" ') ?>
            <!-- <form class="form" method="post" action="<?= base_url('/WorkC/AuthUser')?>"> -->
              ...
              <div class="card-body" >
                ...
                <div class="input-group no-border input-lg">
                  ...
                  <input autocomplete="off" type="username" class="form-control" name="username" id="username" placeholder="Enter Username">
                  <?php echo form_error('username'); ?>
                </div>
                
              <div class="card-footer text-center">
                <button type="submit" class="btn btn-primary btn-round btn-lg btn-block">Send Link</button>
                <div class="pull-left">
                  <h6>
