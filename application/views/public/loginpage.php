    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/images/blurred-image-1.jpg" style="font-size: 1.20571em; letter-spacing: 1px;">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= (!$navbar[$i]->outsidelink) ? base_url($navbar[$i]->link) : $navbar[$i]->link  ?>" target="_<?= $navbar[$i]->target ?>"><?=$navbar[$i]->name?></a>
          </li>
            <?php endif;?>
          <?php endfor;?>   
            ...
            <a class="dropdown-item"  href ="<?=  (!$navbar[$i]->outsidelink) ? base_url($navbar[$i]->link) : $navbar[$i]->link  ?>" target="_<?= $navbar[$i]->target ?>">
      ...
      <?php  include('error.php'); ?>
        ...
        <div class="col-md-4 ml-auto mr-auto">
          ...
          <div class="card card-login card-plain">
            <?= form_open('/WorkC/AuthUser','class="form"') ?>
              ...
              <div class="card-body">
                <div class="input-group no-border input-lg">
                  ...
                  <input autocomplete="off" type="username" class="form-control" name="username" placeholder="Username...">
