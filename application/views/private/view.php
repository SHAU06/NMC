                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                    ...
                                    <?php if($k=='Contact' && $k=='Feedback'):?>
                                       <td class="flex" width="10%"><a href="mailto:<?= $d->email ?>" class="btn btn-success btn-round m-2">Reply</a></a></td>
                                   <?php endif; ?>
                                    <?php if($k!='Contact' && $k!='Feedback'):?>
                                    <?php if ($this->db->field_exists("id", $k)) : ?>
                                    <td class="flex" width="20%"><button class="btn btn-info btn-round m-2" onclick="ConfirmUpdate(<?= $d->id ?>)">Edit</a></button></td>
