...
(5, 'Gaurav Borse', 'gaurav1234@email.com', 'I have some issue. May I contact you.', NULL),
...
(1, 'TRAMBAKESHWAR', '', 'exploring_nashik_dest/trambak1.jpg', '', b'1', NULL),
(2, 'PHALKE SMARAK', '', 'exploring_nashik_dest/PRIMG3.jpg', '', b'1', NULL),
(3, 'PANCHVATI', '', 'exploring_nashik_dest/1.jpg', '', b'1', NULL),
(4, 'PANDUV LENI', '', 'exploring_nashik_dest/pandavlene.jpg', '', b'1', NULL),
(5, 'KALA-RAM MANDIR', '', 'exploring_nashik_dest/kalaram.jpg', '', b'1', NULL),
(6, 'ANJANERI ', '', 'exploring_nashik_dest/PRIMG5.jpg', '', b'1', NULL);
...
(2, 'Shaurya Shete', 'Nice work dear team.', '', NULL),
(3, 'Gaurav Borse', 'I love this site.Thanks alott for all information.', '', NULL);
...
(1, 'food-stuff_home/j6.jpg', 'KOKNI DARBAR ', 'This is the best place in nashik for non vegetarian. Taste of food here is mind blowing. U will not experience such a good taste anywhere in nashik for non veg. The most famous dish over here is chicken sizzlers.', 'Here you can add location url of place...', '', 0, 1),
(2, 'food-stuff_home/sadhna_misal.jpg', 'SADHANA MISAL', 'One who enjoys misal is just gonna fall in love with Sadhana Misal in Nashik which is situated very close to Someshwar. Sadhana is just two and a half years old restaurant and has become so very famous in such a short while ', '', '', 0, 1),
(3, 'food-stuff_home/gulabjamun.jpg', 'BUDDHA HALWAI', 'This is well known mithai shop in Nashik. An iconic place in Nasik since decades.\r\n         Famous for its Jaleebi, but rest of the items are also very tasty.\r\n         One of the must visits in nashik, this is situated in the heart of the city in panchavati.', '', '', 0, 1);
...
INSERT INTO `food-stuff_sec3` (`id`, `name`, `img`, `des`, `main_category`, `order_id`, `active`, `title`) VALUES
...
(1, 'SADHANA MISAL', 'A stronghold with cheery ambiance where the radiant aroma of sizzling flavors is in the air. Designed with a village-setting, the hotel showcases hybrid birds and animals including Emu, Turkey, camels for visitors. The hotel is well-known in Nashik as ‘Chulivarchi Misal’.', 'Here you can add location url of place...', '', 0, 'food-stuff_sec4/sathna-misal1.png', 1),
(2, 'SHAMSUNDAR MISAL', 'Even though this hotel is situated near industrial area, their Misal pav is high on demand. Shamsundar Misal was one of the popular Misal point years ago. Down to increasing competition, the hotel must have lost its name but is striving hard to gain its name and fame by delivering a first class Misal.', '', '', 0, 'food-stuff_sec4/sham-sundar1.jpg', 1),
(3, 'MAMACHA MALA', 'Mamacha Mala perfect for its delicious Misal, is moreover famous for Jalebis. Based on a village-setting, this is a real good place to be visited in weekends with family. The hotel situated in Makhmalabad-Mahsrul link road, will most of all, let', '', '', 0, 'food-stuff_sec4/mamacha-mala2.jpg', 1);
...
(1, 'Nashik', 'Welcome To City Of Diversity', 'home_sec2/dham.jpg', 1, NULL),
...
(1, 'BRAHMAGIRI HILL', 'mountains_dest/brahmagiri.jpg', '', '', b'1', '0', NULL),
(2, 'ALANG MADAN KULANG', 'mountains_dest/AlangMadanKulang.jpg', '', '', b'1', '1', NULL),
(3, 'KALSUBAI', 'mountains_dest/Kalsubai.jpg', '', '', b'1', '2', NULL),
(4, 'HARIHARGAD FORT', 'mountains_dest/HarihargadFort.jpg', '', '', b'1', '3', NULL),
(5, 'RATANGAD FORT', 'mountains_dest/RatangadFort.jpg', '', '', b'1', '4', NULL);
...
(2, 'Destination', 'Nashik Tourism &mdash; Destination', 'pages/dham.jpg ', NULL),
...
(1, 'TRAMBAKESHWAR', 'Counted as the holiest temple of India, the Trimbakeshwar Temple houses one of the most important twelve Jyotirlingas, a form of Lord Shiva.', '', '', 'places_for_worship_dest/trambak1.jpg', 1, NULL),
...
(3, 'SAPTASHRUNGI GADH', 'Situated on a hill range, consisting of seven hills, Saptashrungi is a site of religious significance for Hindus. The drive to the temple is quite scenic, especially during the monsoon season.', '', '', 'places_for_worship_dest/VANI1.jpg', 1, NULL);
...
(1, 'SOMESHWAR WATERFALL ', 'The water fall is located 2 Km away from the Someswar temple and close to Balaji temple. From Panchavati area of Nashik, its only 4-5 Km. It was great \r\n                                        to visit this place during monsoon when the waterfall look lively and vigorous. Its a nice place to spend some time in the evening.', '', 'waterfalls_dest/someshwarWaterfall2.jpg', '', b'1', NULL),
(2, 'VIHIGOAN WATERFALL', 'Vihigaon waterfall also refered to as Ashoka Waterfall\r\n                                         is a fantastic visit. The waterfall is huge &amp; very clear water. You can enjoy yourselves in the pond &amp; stand under it to experience large fresh &amp; big water droplets crashing on your body which feels amazing. Crowd is limited here.', '', 'waterfalls_dest/Vihigaon_Waterfall1.jpg', '', b'1', NULL),
(3, 'DABHOSA WATERFALL', 'Dabhosa Waterfalls is a waterfalls situated in the village of Dabhosa in Jawhar Tehsil, palghar district, Maharashtra, India. This is one of the highest waterfalls situated near Mumbai. Dabhosa Waterfalls is a beautiful waterfall especially, during the monsoon season.', '', 'waterfalls_dest/dabhosaWaterfall1.jpg', '', b'1', NULL);
